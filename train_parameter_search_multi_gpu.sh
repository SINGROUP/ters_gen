...
#SBATCH -o /home/sethih1/masque_new/composnet/ters_gen/log_file/slurm_%config_hypopt_all.out
...
python /home/sethih1/masque_new/composnet/ters_gen/hyperopt_multigpu.py --config $arg1 --use_wandb 
