...
#SBATCH -o /scratch/work/sethih1/slurm_logs/slurm_%config_hypopt_all_augmented_val.out
...
nvidia-smi --query-gpu=timestamp,name,utilization.gpu,utilization.memory,temperature.gpu \
         --format=csv -l 2 > /scratch/work/sethih1/slurm_logs/gpu_usage.log &
GPU_MONITOR_PID=$!

# Optionally, start system resource monitoring: Log CPU, memory, etc. every 1 second
vmstat -n 1 > /scratch/work/sethih1/slurm_logs/resource_usage.log &
